...
def generate_xml(img_name,coords,img_size,out_root_path,target_img_path):
    '''
    输入：
    ...
    path_text = doc.createTextNode(os.path.join(target_img_path,img_name))
