    ...
    for image_id in tqdm(image_ids):
        ...
        if rois.shape[0] > 0:
            ...
            #for roi_id in range(len(rois)):
                ...
                box = rois[roi_id, :]
                box_new = [int(box[0]),int(box[1]),int(box[2]),int(box[3])]
                #print(box_new)
                #cv2.rectangle(ori_imgs[0], ((box_new[0],box_new[1]), (box_new[0]+box_new[2],box_new[1]+box_new[3])), (0,255,0), 2)
            ...
            #cv2.imwrite('./test_cocoeval/{}.jpg'.format(image_id),ori_imgs)
...
def _eval(coco_gt, image_ids, pred_json_path):
    ...
    coco_eval.params.catIds = 1 # 61: add the definition of category id.
    coco_eval.evaluate()
